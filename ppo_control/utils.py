...
def print_experiment(output_file, system_execution, environment_execution):
    # calculate fail rate
    fail_rate = sum([1 for tr in system_execution if tr.status == FAIL])
    fail_rate /= len(system_execution)
