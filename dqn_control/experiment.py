...
def cases_experiment_setup():
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('cases', system=system, environment=environment)
...
# cycle-scc scenario
def cycle_scc_experiment_setup():
    # transitions - system
    t1 = Transition('a', 'g1', 'g2')
    t2 = Transition('b', 'g1', 'g2')
    t3 = Transition('c', 'g1', 'g2')
...
def comb_lock_experiment_setup():
    # transitions - system
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('comb_lock', system=system, environment=environment)

    return dist_sys


# combination lock - more complicated scenario
def comb_lock2_experiment_setup():
    # transitions - system
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('comb_lock2', system=system, environment=environment)
